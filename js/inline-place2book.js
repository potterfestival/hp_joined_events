...
jQuery(document).ready(function($) {
	$('.inline-place2book-ticketinfo').each(function() { 
	    var obj = this;
            $(obj).parent().append("<div class='inline-p2b_preloader'><a href='https://place2book.com/da/14540/list/EM3892'>Henter billetstatus – gå evt. til arrangementsoversigt hos billetudbyder</a><i class='fa fa-cog fa-spin fa fa-fw'></i><div>");
